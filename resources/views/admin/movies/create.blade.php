...
@section('page_title', 'Aggiungi un nuovo Film')
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control {{ $errors->has('release_date') ? 'is-invalid' : '' }}"
                            name="release_date" id="release_dateInput" value="{{ old('release_date') }}">
                        <div class="invalid-feedback">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="number" step="1"
                            ...
                            id="running_timeInput" value="{{ old('running_time') }}">
                        <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control {{ $errors->has('poster_img') ? 'is-invalid' : '' }}"
                            name="poster_img" id="poster_imgInput" value="{{ old('poster_img') }}">
                        <div class="invalid-feedback">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <select class="form-select {{ $errors->has('parental_rating') ? 'is-invalid' : '' }}"
                            name="parental_rating" id="parental_ratingInput">
                            <option value=""></option>
                            @foreach ($movieRatings as $rating)
                                <option value="{{ $rating['code'] }}"
                                    {{ $rating['code'] === old('parental_rating') ? 'selected' : '' }}>
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control {{ $errors->has('original_language') ? 'is-invalid' : '' }}"
                            name="original_language" id="original_languageInput" value="{{ old('original_language') }}">
                        <div class="invalid-feedback">
